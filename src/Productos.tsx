    ...
    <div className="min-h-screen bg-white" id="top">
      <div className="w-full">
        ...
        <section className="w-full">
          ...
          <div className="hidden lg:grid lg:grid-cols-5 h-140">
            {/* Aditivos */}
            <div
          ...
          {/* Mobile y Tablet - Tarjetas verticales */}
          <div className="lg:hidden px-4 sm:px-6">
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {/* Aditivos */}
                <div
                  className="relative cursor-pointer group transition-all duration-300 hover:scale-105 hover:shadow-2xl h-64 sm:h-72 rounded-2xl overflow-hidden"
                  onClick={() => {
                    const element = document.getElementById('section-aditivos');
                    if (element) {
                      const navbarHeight = 80;
                ...
                >
                  <div
                    ...
                    style={{ backgroundImage: 'url(/categorias05.png)' }}
                  />
                ...
                >
                  <div
                    className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-500 group-hover:scale-110"
                    style={{ backgroundImage: 'url(/categorias04.png)' }}
                  />
                ...
                >
                  <div
                    className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-500 group-hover:scale-110"
                    style={{ backgroundImage: 'url(/categorias02.png)' }}
                  />
                ...
                >
                  <div
                    className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-500 group-hover:scale-110"
                    style={{ backgroundImage: 'url(/categorias03.png)' }}
                  />
                ...
                >
                  <div
                    className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-500 group-hover:scale-110"
                    style={{ backgroundImage: 'url(/categorias01.png)' }}
                  />
        ...
        <section id="section-aditivos" className="w-full mb-9">
          <div className="bg-[url('/marcoColores1.png')] bg-cover bg-center py-4 px-4 md:px-10 text-right h-[120px] md:h-[170px]">
            <h1 className="tracking-tight lato-normal text-4xl sm:text-5xl lg:text-7xl" style={{ color: 'rgb(203, 6, 124)' }}>
              Aditivos
            </h1>
            <p className="lato-regular text-2xl md:text-4xl mb-4" style={{ color: 'rgb(23, 99, 141)' }}>
              El plus para tu producto
            </p>
          </div>

          {/* Layout para desktop */}
          <div className="hidden md:grid grid-cols-2 h-100">
          ...
          {/* Layout para móviles - Una sola columna */}
          <div className="md:hidden flex flex-col gap-4 px-4">
            {/* Conservadores */}
            <div
              className="relative cursor-pointer group transition-all duration-300 h-48"
              onClick={() => setHoveredCard(hoveredCard === 'aditivo-conservadores' ? null : 'aditivo-conservadores')}
            >
              ...
              {hoveredCard !== 'aditivo-conservadores' && (
                <div className="absolute inset-0 flex items-center justify-center z-20 rounded-lg">
                  <h3 className="text-slate-100 lato-regular text-2xl text-center px-4">
                    Conservadores
                  </h3>
                </div>
              )}
              ...
              {hoveredCard === 'aditivo-conservadores' && (
                <div className="absolute inset-0 flex items-center justify-center z-20 bg-black/50 rounded-lg">
                  <div className="text-center px-4">
                    <h3 className="text-white lato-regular mb-2 text-xl">
                      Conservadores
                    </h3>
                    <p className="whitespace-pre-line lato-regular text-white/90 text-sm text-left">
                      -Benzoato de sodio{"\n"}-Natamiana{"\n"}-Nisina{"\n"}-Propionato de Calcio{"\n"}-Propionato de Sodio
                    </p>
                  </div>
                </div>
            ...
            <div
              className="relative cursor-pointer group transition-all duration-300 h-48"
              onClick={() => setHoveredCard(hoveredCard === 'aditivo-mejoradores' ? null : 'aditivo-mejoradores')}
            >
              <div className="absolute inset-0 overflow-hidden rounded-lg">
                <img
                  src="/aditivos2.png"
            ...
            <div
              className="relative cursor-pointer group transition-all duration-300 h-48"
              onClick={() => setHoveredCard(hoveredCard === 'aditivo-estabilizantes' ? null : 'aditivo-estabilizantes')}
            >
              <div className="absolute inset-0 overflow-hidden rounded-lg">
                <img
                  src="/aditivos3.png"
            ...
            <div
              className="relative cursor-pointer group transition-all duration-300 h-48"
              onClick={() => setHoveredCard(hoveredCard === 'aditivo-leudantes' ? null : 'aditivo-leudantes')}
            >
              <div className="absolute inset-0 overflow-hidden rounded-lg">
                <img
                  src="/aditivos4.png"
            ...
            <div
              className="relative cursor-pointer group transition-all duration-300 h-48"
              onClick={() => setHoveredCard(hoveredCard === 'aditivo-acidulantes' ? null : 'aditivo-acidulantes')}
            >
              <div className="absolute inset-0 overflow-hidden rounded-lg">
                <img
                  src="/aditivos5.png"
        ...
        <section id="section-colores" className="w-full mb-10">
          <div className="bg-[url('/marcoColores1.png')] bg-cover bg-center py-4 px-4 md:px-10 text-right h-[120px] md:h-[170px]">
            <h1 className="tracking-tight lato-normal text-3xl sm:text-4xl md:text-5xl lg:text-7xl" style={{ color: 'rgb(203, 6, 124)' }}>
              Colores Primarios
            </h1>
            <p className="lato-regular text-lg sm:text-xl md:text-3xl lg:text-4xl mb-2 md:mb-4" style={{ color: 'rgb(23, 99, 141)' }}>
              Disolver para técnicas de agua
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-0 h-auto lg:h-40">
            {/* Azules */}
            <div
              className="relative cursor-pointer group transition-all duration-300 hover:scale-105 hover:shadow-xl hover:z-10 h-48 sm:h-40 lg:h-full"
            ...
            >
              ...
              {hoveredCard !== 'color-azul' && (
                <div className="absolute inset-0 flex items-center justify-center z-20 transition-all duration-300 group-hover:bg-black/50">
                  <h3 className="text-slate-100 lato-regular text-2xl sm:text-3xl text-center px-4">
                    Azules
                  </h3>
                </div>
              )}
              ...
              {hoveredCard === 'color-azul' && (
                <div className="absolute inset-0 flex items-center justify-center z-20 bg-black/50">
                  <div className="text-center px-4">
                    <h3 className="text-white lato-regular mb-2 text-xl sm:text-2xl">
                      Azules
                    </h3>
                    <p className="whitespace-pre-line lato-regular text-white/90 text-sm sm:text-base text-left">
                      -Azul 1{"\n"}-Azul 2
                    </p>
                  </div>
                </div>
            ...
            {/* Amarillos */}
            <div
              className="relative cursor-pointer group transition-all duration-300 hover:scale-105 hover:shadow-xl hover:z-10 h-48 sm:h-40 lg:h-full sm:col-span-2 lg:col-span-1"
        ...
        <section id="section-lacas" className="w-full mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 lg:gap-0 lg:grid-rows-2 h-auto lg:h-80">
            {/* Laca DC Amarillo #5 */}
            <div className="relative cursor-pointer group transition-all duration-300 hover:scale-105 hover:shadow-xl hover:z-10 h-48 sm:h-40 lg:h-full">
              <div className="absolute inset-0 overflow-hidden">
                <img
                  src="/lacas08.png"
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10 transition-all duration-300 group-hover:bg-black/20">
                <h3 className="text-slate-100 lato-regular text-lg sm:text-xl lg:text-3xl text-center px-4 transition-all duration-300 group-hover:text-xl sm:group-hover:text-2xl lg:group-hover:text-4xl group-hover:font-bold">
                  Laca DC Amarillo #5
                </h3>
              </div>
            </div>
...
<section id="section-moldes" className="w-full mb-10">
          <div className="bg-[url('/marcoColores1.png')] bg-cover bg-center py-4 px-4 sm:px-6 lg:px-10 text-center sm:text-right h-[120px] sm:h-[150px] lg:h-[170px]">
            <h1 className="tracking-tight lato-normal text-4xl sm:text-5xl lg:text-7xl" style={{ color: 'rgb(203, 6, 124)' }}>
              Moldes para repostería
            </h1>
            <p className="lato-regular text-xl sm:text-3xl lg:text-4xl mb-4" style={{ color: 'rgb(23, 99, 141)' }}>
              ¡Pregunta por los diseños de nuestro catálogo!
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 h-48 sm:h-56 lg:h-64 gap-1 sm:gap-0">
            {/* Caramelos */}
            <div className="relative h-full cursor-pointer group transition-all duration-300 hover:scale-105 hover:shadow-xl hover:z-10">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-20">
                <h3 className="text-slate-100 lato-regular text-xl sm:text-2xl lg:text-3xl text-center px-2 sm:px-4 transition-all duration-300 group-hover:text-2xl sm:group-hover:text-3xl lg:group-hover:text-4xl">
                  Caramelos
                </h3>
              </div>
            </div>
