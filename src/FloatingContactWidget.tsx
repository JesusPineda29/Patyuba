...
const FloatingContactWidget = () => {
  ...
  // Versión móvil - solo ícono de WhatsApp
  if (isMobile) {
    return (
      <div
        className={`${
      ...
      >
        <a
          ...
          className="w-14 h-14 bg-[rgb(0,169,100)] rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-all duration-300 hover:shadow-green-200/50"
        >
          <svg 
  ...
  // Versión desktop - widget completo
  return (
    <div
      className={`${
        isNearFooter ? 'absolute bottom-4 right-4' : 'fixed bottom-4 right-4'
