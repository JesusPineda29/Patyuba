  ...
  return (
    <div className="min-h-screen bg-slate-200 p-4 md:p-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-min">
        {/* Elemento Negro */}
        <div className="h-48 md:col-start-1 md:row-start-1 md:row-span-3 md:h-[753px] group cursor-pointer">
        ...
        {/* Elemento Azul */}
        <div className="h-48 md:h-80 md:col-start-2 md:col-span-2 group cursor-pointer">
          <div className="relative w-full h-full rounded-xl overflow-hidden shadow-2xl transition-all duration-500 hover:scale-105 hover:-rotate-1 hover:shadow-3xl">
        ...
        {/* Elemento Naranja */}
        <div className="h-48 md:col-start-4 md:row-start-2 md:row-span-2 md:h-[545px] group cursor-pointer">
